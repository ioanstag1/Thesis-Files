...
def config():
    ...
    unique_model_path = f'./runs/weight_{timestamp}'
    parser.add_argument('--model_path', type=str, default=unique_model_path)
    parser.add_argument('--writer_comment', type=str, default='GDPHSYSUCC')
    parser.add_argument('--save_model', type=bool, default=True)
    os.makedirs(unique_model_path, exist_ok=True)
   ...
   # MODEL PARAMETER
    ...
    parser.add_argument('--num_heads', type=list, default=[2, 4, 8, 16])# adjusted for fiting the attn mix
